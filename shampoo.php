	...
	<div class="row mt-5" >
			<div class="col-4 mt-3">
				<div class="card card-outline-primary">
					<img src="img/shampoo corporal con aceites tropicales.jpg" class="card-img-top img-fluid" id="fondo" alt="">		
				</div>
			</div>
			...
			<div class="col-8 mt-3">
				<div class="card " style="background-color:   #F39C12">
					<div class="card-block ">
						<h1 class=" card-title text-center">Shampoo corporal con aceites tropicales</h1>
						<p class="card text-left">
								<h4>Tratamiento auxilar:</h4>
                                <p>este shampoo es más concentrado que el shampoo para 
                                cabello, contiene 20% de aloe vera.
                                con una fuente de aceites tropicales de neem y
                                 karanja.
                                con gotitas puede limpiar todo su cuerpo con mucha 
                                espuma y es humectante <br>
                                disfrute bañándose.
                                <br>
                                 <p>Cont. 480 ml
