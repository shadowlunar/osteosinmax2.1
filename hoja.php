	...
	<div class="row mt-5" >
			<div class="col-4 mt-3">
				<div class="card card-outline-primary">
					<img src="img/capsulas de hoja de neem.jpg" class="card-img-top img-fluid" id="fondo" alt="">		
				</div>
			</div>
			...
			<div class="col-8 mt-3">
				<div class="card " style="background-color:   #F39C12">
					<div class="card-block ">
						<h1 class=" card-title text-center">Capsulas de hoja de neem </h1>
						<p class="card text-left">
								<h4>Tratamiento auxilar:</h4>
                                <p>Las hojas de neem  mejora la salud general,
                                 mejora la respuesta del
                                 sistema inmunológico saludable y apoya las
                                  funciones del sistema digestivo<br>
                                 <p>Cont. 90 capsulas
		...
		<div class="col">
			<div class="card " style="background: #F1C40F  " >
				<div class="card-block">
						...
						<p class=" text-center">
						Se recomienda tomar 2 capsulas por la mañana y 2 por la noche 
						</p>
