	...
	<div class="row mt-5" >
			<div class="col-4 mt-3">
				<div class="card card-outline-primary">
					<img src="img/neem patli  hojas de neem.jpg" class="card-img-top img-fluid" id="fondo" alt="">		
				</div>
			</div>
			...
			<div class="col-8 mt-3">
				<div class="card " style="background-color:   #F39C12">
					<div class="card-block ">
						<h1 class=" card-title text-center">Neem patli hojas de neem</h1>
						<p class="card text-left">
								<h4>Tratamiento auxilar:</h4>
                                <p>las hojas de neem  mejora la salud general,
                                 mejora la respuesta del
                                 sistema inmunológico saludable y
                                 apoya las funciones del sistema digestivo
                                <br>
                                 <p>Cont. 90 Capsulas
		...
		<div class="col">
			<div class="card " style="background: #F1C40F  " >
				<div class="card-block">
						...
						<p class=" text-center">
						tomar 2 capsulas por la mañana y 2 por la noche 
						</p>
