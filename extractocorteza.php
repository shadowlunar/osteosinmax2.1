	...
	<div class="row mt-5" >
			<div class="col-4 mt-3">
				<div class="card card-outline-primary">
					<img src="img/extractos de corteza de neem.jpg" class="card-img-top img-fluid" id="fondo" alt="">		
				</div>
			</div>
			...
			<div class="col-8 mt-3">
				<div class="card " style="background-color:   #F39C12">
					<div class="card-block ">
						<h1 class=" card-title text-center">Extractos de corteza de neem </h1>
						<p class="card text-left">
								<h4>Tratamiento auxilar:</h4>
                                <p>extracto de corteza tiene la mayoría  de los mismos usos  
                                terapéutico que el extracto  de hojas de neem .
                                la corteza es mas  concentrado que los extractos de hojas de neem ,
                                 se le recomienda  mayormente su uso a personas que padecen dolor
                                  reumatoide artríticos y gente con depresión del sistema inmune.
                                <br>
                                 <p>Cont. 60 ml
