	...
	<div class="row mt-5" >
			<div class="col-4 mt-3">
				<div class="card card-outline-primary">
					<img src="img/Inmuno ten Inmunilógico 1.png" class="card-img-top img-fluid" id="fondo" alt="">		
				</div>
			</div>
			...
			<div class="col-8 mt-3">
				<div class="card " style="background-color:   #F39C12">
					<div class="card-block ">
						<h1 class=" card-title text-center">Imunoten</h1>
						<p class="card text-left">
								<h4>Tratamiento auxilar:</h4>
                                <p>Fortalece y regula el sistema inmunológico,
                                <p>Reduce la ansiedad y el estrés  
                                <p>Funciona como antibacterial, 
                                <p>antiviral y antimicótico. 
		...
		<div class="col">
			<div class="card " style="background: #F1C40F  " >
				<div class="card-block">
						...
						<p class=" text-center">
						 tomar 2 capsulas media hora antes de cada alimento
						</p>
