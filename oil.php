	...
	<div class="row mt-5" >
			<div class="col-4 mt-3">
				<div class="card card-outline-primary">
					<img src="img/neem oil natural  face cream.jpg" class="card-img-top img-fluid" id="fondo" alt="">		
				</div>
			</div>
			...
			<div class="col-8 mt-3">
				<div class="card " style="background-color:   #F39C12">
					<div class="card-block ">
						<h1 class=" card-title text-center">neem oil natural  face cream  </h1>
						<p class="card text-left">
								<h4>Tratamiento auxilar:</h4>
                                <p>se recomienda su uso para todos tipos de piel por sus efectos 
                                depurativos los cuales protegen y 
                                humectan la piel. tiene cualidades desintoxicantes<br>
                                 <p>
