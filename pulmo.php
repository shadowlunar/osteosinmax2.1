	...
	<div class="row mt-5" >
			<div class="col-4 mt-3">
				<div class="card card-outline-primary">
					<img src="img/pulmo.jpg" class="card-img-top img-fluid" id="fondo" alt="">		
				</div>
			</div>
			...
			<div class="col-8 mt-5">
				<div class="card " style="background-color:   #F39C12">
					<div class="card-block ">
						<h1 class=" card-title text-center">Pulmo Calcio Plus</h1>
						<p class="card text-left">
								<h4>Tratamiento auxilar:</h4>
                                Descongestionamiento bronquial y nasal <br>
                                Auxiliar en gripe <br>
                                Influenza <br>
                                Catarros <br>
                                Bronquitis <br>
                                Congestión pulmonar y neumonia <br>
                                Refuerza el sistema inmunológico <br>
                                Frasco con 30 perlas
