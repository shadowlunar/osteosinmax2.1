	...
	<div class="row mt-5" >
			<div class="col-4 mt-3">
				<div class="card card-outline-primary">
					<img src="img/Prosta wiix.png" class="card-img-top img-fluid" id="fondo" alt="">		
				</div>
			</div>
			...
			<div class="col-8 mt-3">
				<div class="card " style="background-color:   #F39C12">
					<div class="card-block ">
						<h1 class=" card-title text-center">Prosta Wiix</h1>
						<p class="card text-left">
								<h4>Tratamiento auxilar:</h4>
                                <p>CASOS DE PRÓSTATA INFLAMADA BENIGNA 
                                <p>PROSTATISMO CRÓNICO 
                                <p>AYUDA A REDUCIR 
                                <p>EL RIESGO DE ENFERMEDAD DEGENERATIVA Y
                                <p>MALIGNA
