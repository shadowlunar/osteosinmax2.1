	...
	<div class="row mt-5" >
			<div class="col-4 mt-3">
				<div class="card card-outline-primary">
					<img src="img/Riñón sano plus 1.png" class="card-img-top img-fluid" id="fondo" alt="">		
				</div>
			</div>
			...
			<div class="col-8 mt-3">
				<div class="card " style="background-color:   #F39C12">
					<div class="card-block ">
						<h1 class=" card-title text-center">Riñón sano plus </h1>
						<p class="card text-left">
								<h4>Tratamiento auxilar:</h4>
                                <p>PROBLEMAS DE URINARIOS 
                                <p>INFECCIONES URINARIAS
                                <p>DOLOR RENAL 
