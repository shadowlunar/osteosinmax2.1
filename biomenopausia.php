	...
	<div class="row mt-5" >
			<div class="col-4 mt-3">
				<div class="card card-outline-primary">
					<img src="img/bio menopausia plus.png" class="card-img-top img-fluid" id="fondo" alt="">		
				</div>
			</div>
			...
			<div class="col-8 mt-3">
				<div class="card " style="background-color:   #F39C12">
					<div class="card-block ">
						<h1 class=" card-title text-center">Biomenopausia</h1>
						<p class="card text-left">
								<h4>Tratamiento auxilar:</h4>
                                <p>AYUDA A REDUCIR LOS SÍNTOMAS DE LA MENOPAUSIA, 
                                <p>COMO BOCHORNOS REPENTINOS DE NOCHE ,
                                <p>SUDORES NOCTURNOS,
                                <p>DOLOR EN LOS SENOS (MASTALGIA), 
                                <p>ALIVIA LOS SÍNTOMAS DEL SÍNDROME PREMENSTRUAL (SPM)
		...
		<div class="col">
			<div class="card " style="background: #F1C40F  " >
				<div class="card-block">
						...
						<p class=" text-center">
						tomar 2 capsulas, media hora antes del desayuno y cena. 
						</p>
