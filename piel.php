	...
	<div class="row mt-5" >
			<div class="col-4 mt-3">
				<div class="card card-outline-primary">
					<img src="img/Piel sana plus.png" class="card-img-top img-fluid" id="fondo" alt="">		
				</div>
			</div>
			...
			<div class="col-8 mt-3">
				<div class="card " style="background-color:   #F39C12">
					<div class="card-block ">
						<h1 class=" card-title text-center">Piel Sana Plus</h1>
						<p class="card text-left">
								<h4>Tratamiento auxilar:</h4>
                                <p>PROBLEMAS DE LA PIEL 
                                <p>DERMATITIS SEBORREICA 
                                <p>PSORIASIS  
                                <p>OTRAS ENFERMEDADES CUTANEAS 
